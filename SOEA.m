...
%                 if rand(1)<0.9
                child(count) = crossover(child(count),population(p1),population(p2),cf,0);
                child(count+1) = crossover(child(count+1),population(p2),population(p1),cf,0);
%                 else
%                   child(count) =  population(p1);
%                   child(count+1) =  population(p2);
%                 end
%                 if rand(1) < 0.1
